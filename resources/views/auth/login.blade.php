            ...
            <div class="card-body">
                ...
                <form method="POST" id="loginform" class="form-horizontal form-material" action="{{ route('login') }}" aria-label="{{ __('Login') }}">
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            <input id="username" type="text" placeholder="Email Address" class="mt-3 form-control{{ $errors->has('username') ? ' is-invalid' : '' }}" name="username" value="{{ old('username') }}" required autofocus>
